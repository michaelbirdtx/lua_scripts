...
local spells = {
    ...
    {class = 801, level = 10, type = 0, entry = 59607, name = "Heroic Strike"},
    {class = 801, level = 10, type = 3, entry = 45,    name = "Challenger"},
    {class = 801, level = 20, type = 0, entry = 56909, name = "Cleave (weak)"},
    ...
    {class = 801, level = 30, type = 0, entry = 8078,  name = "Thunderclap"},
